{ config, pkgs, lib, ... }: {
  ...
  services.klipper = {
    enable = true;
    configFile = ./voron24-klipper.cfg;
    ...
    firmwares.voron24 = {
      ...
      configFile = ./voron24-octopus11-firmware.cfg;
    };
  };
  ...
  services.fluidd = {
    ...
    hostName = "voronix";
    nginx = {
      # serverAliases = [ "10.X.X.X" "voronix.vor123456.google.beta.tailscale.net" ]; # determine after deployment?
    };
  };
