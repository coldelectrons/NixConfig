...
#     workaround for xauth or whatever
{
  ...
  services.udev.extraRules = ''
    ...
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c603", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c605", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c606", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c621", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c623", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c625", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c626", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c627", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c628", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c629", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c62b", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c62e", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c62f", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c631", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c632", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c633", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c635", MODE="0666", GROUP="plugdev", SYMLINK+="input/spacemouse_compact", SYMLINK+="input/3dconnexion"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c636", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c640", MODE="0666", GROUP="plugdev"
    KERNEL=="event[0-9]*", ATTRS{idVendor}=="256f", ATTRS{idProduct}=="c652", MODE="0666", GROUP="plugdev"
  '';
}
